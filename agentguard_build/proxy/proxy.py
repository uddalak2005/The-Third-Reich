...
A userspace fallback for environments where eBPF isn't available.
...
def inspect_body(body: bytes) -> Tuple[int, List[str]]:
    ...
    Score > 0 means suspicious. Score > 50 means high confidence injection.
    """
    if not body:
        return 0, []
...
class ProxyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def _send_block(self, reason: str, detail: dict):
        ...
        self._send_error(403, reason, body)
