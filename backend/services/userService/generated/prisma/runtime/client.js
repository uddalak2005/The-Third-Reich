...
function He(e = {}) {
    ...
    return Object.entries(t).reduce(
        (n, [i, o]) => (
            Mo[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
            n
        ),
        { select: {} },
    );
            ...
            let n = async () => {
                ...
                try {
                    ...
                    ((t.status = r),
                        ...
                        this.closedTransactions.length > Gd &&
...
${n.backtrace}`,
    ...
    async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
        ...
        if (cl(t)) s = pl(t);
            ...
            let { parameterizedQuery: l, placeholderValues: u } = za(
                    t,
                    this.#o,
                ),
                c = JSON.stringify(l);
    ...
    async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
        ...
        if (c) p = this.#g(t, a, u);
            ...
            let { parameterizedBatch: m, placeholderValues: g } = Wa(
                    s,
                    this.#o,
                ),
                x = JSON.stringify(m);
